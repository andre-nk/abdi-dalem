...
class BadHabitPreviewer extends StatefulWidget {
  ...
  BadHabitPreviewer({this.title, this.subtitle, this.uid, this.limit, this.currentCount, this.isProtected});
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text("current: ${widget.limit}",
                      style: GoogleFonts.karla(
                        color: Theme.of(context).accentColor,
                        fontSize: 18,
                        fontWeight: FontWeight.w500),
                  ...
                  DefaultButton(
                    method: () async {
                      ...
                      BadHabitServices().updateBadHabitRecord(
                        ...
                        subtitle: descriptionController.text != "" ? descriptionController.text : widget.subtitle,
